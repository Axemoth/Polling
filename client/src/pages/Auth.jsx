      ...
      >
        <div className="mb-8 text-center">
           ...
           <h1 className="text-3xl font-black tracking-tighter text-white sm:text-4xl">
             {isLogin ? "Welcome back." : "Join Axepoll."}
           </h1>
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  ...
                  <Input 
                    ...
                    placeholder="••••••••" 
                    className={`bg-zinc-900/50 pl-10 pr-10 text-white h-11 ${password.length > 0 && password.length < 6 ? 'border-red-500 focus:border-red-500' : 'border-white/5 focus:border-cyan-500/50'}`}
                    value={password}
